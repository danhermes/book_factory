#!/usr/bin/env bash
# =========================================================================
# Book Factory Consolidated Service Deployment Script
# =========================================================================
# This script handles building and running the Docker container for the 
# consolidated book_factory service with proper error handling and logging.
#
# Author: AI Assistant
# Date: 2025-07-29
# =========================================================================
...
show_usage() {
    ...
    echo
    echo "Options:"
    echo "  build       Build the Docker image for the book_factory service"
    echo "  run         Run the Docker container for the book_factory service"
