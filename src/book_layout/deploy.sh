#!/usr/bin/env bash
# =========================================================================
# Book Layout Module Deployment Script
# =========================================================================
# This script handles building and running the Docker container for the 
# book_layout service with proper error handling and logging.
#
# Author: AI Assistant
# Date: 2025-07-29
# =========================================================================
...
show_usage() {
    ...
    echo
    echo "Options:"
    echo "  build       Build the Docker image for the book_layout service"
    echo "  run         Run the Docker container for the book_layout service"
