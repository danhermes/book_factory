...
class OutlineCrew:
    ...
    def __init__(self):
        ...
        #self.rag_provider = RagContentProvider(RAG_CONTENT_FILES)
    ...
    def research_task(self) -> Task:
        ...
        #     {
        #         "key": "book_outline",
        #         "value": self.rag_provider.get_file_content("book_outline"),
        #         "description": "The book outline",
        #         "expected_output": "A string"
        #     },
        #     {
        #         "key": "chapter_content",
        #         "value": self.rag_provider.get_file_content("chapter_content"),
    ...
    def write_outline(self) -> Task:
        ...
        #     outline_content = self.rag_provider.get_file_content("book_outline")
        ...
        #     output_pydantic=Outline,
        #     inputs={
        #     "book_title": "ChatGPT for the Office",
        #     "topic": "ChatGPT for Business",
        #     "book_outline": self.rag_provider.get_file_content("book_outline"),
        #     "chapter_content": self.rag_provider.get_file_content("chapter_content")
        #     }
        # )
