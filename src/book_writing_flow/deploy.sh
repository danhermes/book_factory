#!/usr/bin/env bash
# =========================================================================
# Book Writing Flow Module Deployment Script
# =========================================================================
# This script handles building and running the Docker container for the 
# book_writing_flow service with proper error handling and logging.
#
# Author: AI Assistant
# Date: 2025-07-29
# =========================================================================
...
SERVICE_NAME="book_writing_flow"
...
show_usage() {
    ...
    echo
    echo "Options:"
    echo "  build       Build the Docker image for the book_writing_flow service"
    echo "  run         Run the Docker container for the book_writing_flow service"
